(define (problem zeno-0) (:domain zeno-travel)
	...
	(:tasks-goal
		:tasks(
			...
			(transport-person p8 almeria)
			(transport-person p9 almeria)
			(transport-person p10 almeria)
			(transport-person p11 almeria)
			(transport-person p12 almeria)
			(transport-person p13 almeria)
			(transport-person p14 almeria)
			(transport-person p15 almeria)
			(transport-person p16 almeria)
			(transport-person p17 almeria)
			(transport-person p18 almeria)
			(transport-person p19 almeria)
			(transport-person p20 almeria)
		)
	)
)
