  ...
  ;OBJETOS DEL MUNDO
	...
	(:INIT
		...
		;FILAS
		 ...
		 (= (distance Z12 Z13 ) 1)
		 (= (distance Z13 Z12 ) 1)
		 (= (distance Z13 Z14 ) 200)
		 (= (distance Z14 Z13 ) 200)
		 (= (distance Z14 Z15 ) 200)
		 (= (distance Z15 Z14 ) 200)
		 
		 (= (distance Z16 Z17 ) 1)
		 (= (distance Z17 Z16 ) 1)
		 (= (distance Z17 Z18 ) 1)
		 (= (distance Z18 Z17 ) 1)
		 (= (distance Z18 Z19 ) 200)
		 (= (distance Z19 Z18 ) 200)
		 (= (distance Z19 Z20 ) 200)
		 (= (distance Z20 Z19 ) 200)
		 
		 (= (distance Z21 Z22 ) 1)
		 (= (distance Z22 Z21 ) 1)
		 (= (distance Z22 Z23 ) 1)
		 (= (distance Z23 Z22 ) 1)
		 (= (distance Z23 Z24 ) 200)
		 (= (distance Z24 Z23 ) 200)
		 (= (distance Z24 Z25 ) 1)
		 (= (distance Z25 Z24 ) 1)
	...
	(:goal 
		 (and  (has_personaje BRUJA MANZANA))
