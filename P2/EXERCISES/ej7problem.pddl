(define (problem ej7)
  ...
  ;OBJETOS DEL MUNDO
		(:OBJECTS 
		 ...
		 PLAYER_GIVE - jugador_give PLAYER_GET - jugador_get
	...
	(:INIT
       ...
       (is_z Z1 AGUA)
        ...
        (at_objeto BIKINI Z19)
		 ...
		 (= (max_capacity PRINCIPE) 1)
		 (= (max_capacity PRINCESA) 2)
		 (= (max_capacity BRUJA) 3)
		 (= (max_capacity LEONARDO) 6)
		 (= (max_capacity PROFESOR) 7)
		 
		 ;Cuanos objetos tienen al principio
		 (= (how_many PRINCIPE) 0)
		 (= (how_many PRINCESA) 0)
		 (= (how_many BRUJA) 0)
		 (= (how_many PROFESOR) 0)
		 ...
		 ;PLAYER
		 (at_jugador PLAYER_GIVE Z13)
		 (empty_hand PLAYER_GIVE)
		 (empty_back PLAYER_GIVE)
		 (orientation_player PLAYER_GIVE este)
		 
		 (at_jugador PLAYER_GET Z18)
		 (orientation_player PLAYER_GET oeste)
		 (empty_hand PLAYER_GET)
		 (empty_back PLAYER_GET)
		 (= (points_player PLAYER_GET) 0)
	...
	(:goal 
		 ...
		 ;P6
		 ;(and (at_jugador PLAYER1 Z5) (at_jugador PLAYER2 Z6))
		 ;(and (>= (points_player PLAYER1) 11) (>= (points_player PLAYER2) 31) (>= (total_points) 50))
