	...
	(:INIT
       ...
       (is_z Z1 AGUA)
        ...
        (at_objeto BIKINI Z19)
		 ...
		 ;PLAYER
		 (at_jugador PLAYER1 Z13)
		 (empty_hand PLAYER1)
		 (empty_back PLAYER1)
		 (orientation_player PLAYER1 este)
		 (= (points_player PLAYER1) 0)
		 
		 (at_jugador PLAYER2 Z18)
		 (orientation_player PLAYER2 oeste)
		 (empty_hand PLAYER2)
		 (empty_back PLAYER2)
		 (= (points_player PLAYER2) 0)
